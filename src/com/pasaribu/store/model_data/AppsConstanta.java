...
public class AppsConstanta {
	...
	public static String URL_INSERT_SUPPLIER 	= "http://192.168.56.5/pasaribu_store/function/insert_supplier.php"; 
	public static String URL_INSERT_PRODUCT 	= "http://192.168.56.5/pasaribu_store/function/insert_product.php"; 
	public static String URL_SUPPLIER_AND_BRAND = "http://192.168.56.5/pasaribu_store/function/get_supplier_and_brand.php";  //Ambil data supplier
